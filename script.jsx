...
var NumbersFrame = React.createClass({
  render: function() {
    var numbers=[], className, 
                ...
                selectedNumber = this.props.selectedNumbers;
    
    for (var i = 1; i <= 9; i++) {
      className = "number selected-" + (selectedNumber.indexOf(i) >= 0);
...
var Game = React.createClass({
  ...
  sumOfSelectedNumbers: function() {
    ...
    // The zero indicates the initial value
